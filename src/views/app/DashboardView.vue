...
import { PhArrowFatLinesUp, PhPlay } from '@phosphor-icons/vue'
</script>
      ...
      <aside class="w-full flex flex-col gap-14">
        ...
        >
          <div class="overflow-clip rounded-2xl flex gap-1 h-full">
            <span class="bg-white w-28 inline-flex justify-center items-center">3</span>
            <span class="bg-white w-28 inline-flex justify-center items-center">5</span>
          </div>
          ...
          <div class="overflow-clip rounded-2xl flex gap-1 h-full">
            <span class="bg-white w-28 inline-flex justify-center items-center">0</span>
            <span class="bg-white w-28 inline-flex justify-center items-center">0</span>
          </div>
        </div>
